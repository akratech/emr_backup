    ...
    public function password_email(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($query) {
                ...
                $data2['message_data'] = 'This message is to notify you that you have reset your password with MOBIHEALTH INTERNATIONAL.<br>';
                ...
                $this->send_mail('auth.emails.generic', $data2, 'Reset password', $request->input('email'), $query->practice_id);
